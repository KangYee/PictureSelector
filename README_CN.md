# PictureSelector 3.0
   ...
   [效果体验](https://github.com/LuckSiege/PictureSelector/raw/version_component/app/demo/demo_2023-04-16_100140_v3.11.4.apk)<br>
...
## 目录
-[最新版本](https://github.com/LuckSiege/PictureSelector/releases/tag/v3.11.4)<br>
-[如何引用](#如何引用)<br>
-[进阶使用](#进阶使用)<br>
-[权限](#权限)<br>
